...
import { sendGroupSchema } from "../../../../validation";
import { TSendGroup } from "../../../../types";
...
import { useGetGroupListsQuery } from "../../../../app/functions/api/groupsListsApi";
...
const SendListPage = () => {
  ...
  const { data: GroupList, isLoading } = useGetGroupListsQuery();
  ...
  const onSubmit = async (data: TSendGroup) => {
    try {
          ...
          <div className="w-full flex flex-col items-center justify-between space-y-8">
            <div className="w-full flex flex-col items-center justify-between">
              ...
              <div className="w-full flex flex-col items-center gap-3">
                ...
                <div className="w-full flex items-end">
                  <InputErrorMessage msg={errors.group_id?.message} />
                </div>
              </div>
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    ...
                    if (editor && variableName.match(/^[a-zA-Z_]+$/)) {
                      ...
                      toast.error(t("englishOnlyError"), {
                        duration: 4000,
                      });
                    }
                  }
